...
return[
    ...
    'ctrl-vision' => 'To modernize academic and administrative procedures, based on information and communication technologies, to facilitate access to services for our professors and students, under an avant-garde scheme of the XXI century.',
    'ctrl-valors' => 'Values',
    'ctrl-valors-1' => 'Responsibility: to assume with great value each of the tasks to be performed.',
    'ctrl-valors-2' => 'Empathy: "putting yourself in the others shoes" is a fundamental principle to understand the flow of any process.',
    ...
    'ctrl-function-1' => 'Request the pertinent documentation in the university admission process and keep them in each university students file.',
