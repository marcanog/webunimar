            ...
            <div class="card-columns col-sm-12 ml-2">
                <a class="btn-link card-img" id="imgcard">
                    <div class="card row" id="cardauthor">
                        <div class="col-md-4">
                            <img id="imgcrd" src="{{URL::asset('/image/secretarygeneral/secgeneral.jpg')}}"
                                 alt="Fanny Marcano">
                        </div>
                        <div class="card-title col-md-8">
                            <p id="vext-author">{{trans('secretarygeneral.secretaryofic-author')}}</p>
                            <p id="vext-authort">{{trans('secretarygeneral.secretaryofic-author-title')}}</p>
                            <p id="vext-email">{{trans('secretarygeneral.secretaryofic-author-email')}}</p>
                        </div>
                    </div>
                </a>
                <a class="btn-link card-img" id="imgcard">
                    <div class="card row" id="cardauthor">
                        ...
                        <div class="card-title col-md-8">
                            <p id="vext-author">{{trans('secretarygeneral.secretaryofic-asist')}}</p>
                            <p id="vext-authort">{{trans('secretarygeneral.secretaryofic-atitle')}}</p>
                            <p id="vext-email">{{trans('secretarygeneral.secretaryofic-asitmail')}}</p>
                        </div>
                    </div>
                </a>
            </div>
